...
def setup():
    global img
    py5.size(800, 400)
    img = py5.load_image("img/images.jpg")
    img.resize(400, 400)
...
def draw():
    ...
    for x in range(img.width):
        for y in range(img.height):
            ...
            #Suprimir el canal rojo por completo:
            # r = 0
          # ¿Qué pasa con las zonas que eran originalmente rojas?
            ''' Las zonas rojas se vuelven claras
            '''

            #Controlar un canal distinto:
            g = g * factor_rojo
            ...
            '''Esto intercambia el canal rojo y el azul. Los cielos de color azul deberían volverse rojizos. Pensá qué implica esto: los colores son datos, y cambiar su posición genera una imagen que parece incorrecta pero matemáticamente es válida'''
